...
static c_keyword_t const C_KEYWORDS[] = {
  ...
  // C11
  { L__ALIGNAS,         Y__ALIGNAS,         TB_NONE,        LANG_C_MIN(11)    },
  { L__ALIGNOF,         Y__ALIGNOF,         TB_NONE,        LANG_C_MIN(11)    },
  { L__ATOMIC,          Y__ATOMIC_QUAL,     TS_ATOMIC,      LANG_MIN(C_11)    },
  { L__GENERIC,         Y__GENERIC,         TB_NONE,        LANG_C_MIN(11)    },
  { L__NORETURN,        Y__NORETURN,        TA_NORETURN,    LANG_C_MIN(11)    },
  { L__STATIC_ASSERT,   Y__STATIC_ASSERT,   TB_NONE,        LANG_C_MIN(11)    },
  { L__THREAD_LOCAL,    Y__THREAD_LOCAL,    TS_THREAD_LOCAL,LANG_C_MIN(11)    },

  // C++
  { L_BOOL,             Y_BOOL,             TB_BOOL,        LANG_CPP_ALL      },
  { L_CATCH,            Y_CATCH,            TB_NONE,        LANG_CPP_ALL      },
  { L_CLASS,            Y_CLASS,            TB_CLASS,       LANG_CPP_ALL      },
  { L_CONST_CAST,       Y_CONST_CAST,       TB_NONE,        LANG_CPP_ALL      },
  { L_DELETE,           Y_DELETE,           TS_DELETE,      LANG_CPP_ALL      },
  { L_DYNAMIC_CAST,     Y_DYNAMIC_CAST,     TB_NONE,        LANG_CPP_ALL      },
  { L_EXPLICIT,         Y_EXPLICIT,         TS_EXPLICIT,    LANG_CPP_ALL      },
  { L_FALSE,            Y_FALSE,            TS_NONE,        LANG_CPP_ALL      },
  ...
  { L_NEW,              Y_NEW,              TB_NONE,        LANG_CPP_ALL      },
  { L_OPERATOR,         Y_OPERATOR,         TB_NONE,        LANG_CPP_ALL      },
  { L_PRIVATE,          Y_PRIVATE,          TB_NONE,        LANG_CPP_ALL      },
  { L_PROTECTED,        Y_PROTECTED,        TB_NONE,        LANG_CPP_ALL      },
  { L_PUBLIC,           Y_PUBLIC,           TB_NONE,        LANG_CPP_ALL      },
  { L_REINTERPRET_CAST, Y_REINTERPRET_CAST, TB_NONE,        LANG_CPP_ALL      },
  { L_STATIC_CAST,      Y_STATIC_CAST,      TB_NONE,        LANG_CPP_ALL      },
  { L_TEMPLATE,         Y_TEMPLATE,         TB_NONE,        LANG_CPP_ALL      },
  { L_THIS,             Y_THIS,             TB_NONE,        LANG_CPP_ALL      },
  { L_THROW,            Y_THROW,            TS_THROW,       LANG_CPP_ALL      },
  { L_TRUE,             Y_TRUE,             TS_NOEXCEPT,    LANG_CPP_ALL      },
  { L_TRY,              Y_TRY,              TB_NONE,        LANG_CPP_ALL      },
  { L_TYPEID,           Y_TYPEID,           TB_NONE,        LANG_CPP_ALL      },
  { L_TYPENAME,         Y_TYPENAME,         TB_NONE,        LANG_CPP_ALL      },
  { L_USING,            Y_USING,            TS_TYPEDEF,     LANG_CPP_ALL      },
  { L_VIRTUAL,          Y_VIRTUAL,          TS_VIRTUAL,     LANG_CPP_ALL      },

  // C++11
  { L_ALIGNAS,          Y_ALIGNAS,          TB_NONE,        LANG_CPP_MIN(11)  },
  { L_ALIGNOF,          Y_ALIGNOF,          TB_NONE,        LANG_CPP_MIN(11)  },
  { L_AUTO,             Y_AUTO_TYPE,        TB_AUTO,        LANG_CPP_MIN(11)  },
  { L_CONSTEXPR,        Y_CONSTEXPR,        TS_CONSTEXPR,   LANG_CPP_MIN(11)  },
  { L_DECLTYPE,         Y_DECLTYPE,         TB_NONE,        LANG_CPP_MIN(11)  },
  { L_FINAL,            Y_FINAL,            TS_FINAL,       LANG_CPP_MIN(11)  },
  { L_NOEXCEPT,         Y_NOEXCEPT,         TS_NOEXCEPT,    LANG_CPP_MIN(11)  },
  { L_NULLPTR,          Y_NULLPTR,          TB_NONE,        LANG_CPP_MIN(11)  },
  { L_OVERRIDE,         Y_OVERRIDE,         TS_OVERRIDE,    LANG_CPP_MIN(11)  },
  { L_STATIC_ASSERT,    Y_STATIC_ASSERT,    TB_NONE,        LANG_CPP_MIN(11)  },
  ...
  // C++20
  { L_CONCEPT,          Y_CONCEPT,          TB_NONE,        LANG_CPP_MIN(20)  },
  ...
  { L_REQUIRES,         Y_REQUIRES,         TB_NONE,        LANG_CPP_MIN(20)  },

  // Alternative tokens
  { L_AND,              Y_AMPER2,           TB_NONE,       LANG_MIN(C_89)     },
  { L_AND_EQ,           Y_AMPER_EQ,         TB_NONE,       LANG_MIN(C_89)     },
  { L_BITAND,           Y_AMPER,            TB_NONE,       LANG_MIN(C_89)     },
  { L_BITOR,            Y_PIPE,             TB_NONE,       LANG_MIN(C_89)     },
  { L_COMPL,            Y_TILDE,            TB_NONE,       LANG_MIN(C_89)     },
  { L_NOT,              Y_EXCLAM,           TB_NONE,       LANG_MIN(C_89)     },
  { L_NOT_EQ,           Y_EXCLAM_EQ,        TB_NONE,       LANG_MIN(C_89)     },
  { L_OR,               Y_PIPE2,            TB_NONE,       LANG_MIN(C_89)     },
  { L_OR_EQ,            Y_PIPE_EQ,          TB_NONE,       LANG_MIN(C_89)     },
  { L_XOR,              Y_CIRC,             TB_NONE,       LANG_MIN(C_89)     },
  { L_XOR_EQ,           Y_CIRC_EQ,          TB_NONE,       LANG_MIN(C_89)     },
