...
decl_english_ast
  ...
  | constructor_decl_english_ast  { $$ = (c_ast_pair_t){ $1, NULL }; }
  | destructor_decl_english_ast   { $$ = (c_ast_pair_t){ $1, NULL }; }
...
array_decl_english_ast
  : Y_ARRAY static_tid_opt type_qualifier_list_english_tid_opt
    array_size_int_opt of_exp decl_english_ast
    {
      ...
      $$.ast->as.array.size = $4;
      $$.ast->as.array.store_tid = c_type_id_check( $2 | $3, C_TPID_STORE );
  ...
  | Y_VARIABLE length_opt array_exp type_qualifier_list_english_tid_opt
    of_exp decl_english_ast
    {
      ...
      $$.ast->as.array.store_tid = c_type_id_check( $4, C_TPID_STORE );
      c_ast_set_parent( $6.ast, $$.ast );
...
oper_decl_english_ast
  : type_qualifier_list_english_tid_opt { ia_qual_push_tid( $1, &@1 ); }
    ...
    operator_exp paren_decl_list_english_opt returning_english_ast_opt
    {
      ...
      $$.ast->type.store_tid = c_type_id_check( $1 | $3, C_TPID_STORE );
...
qualifiable_decl_english_ast
  ...
  | func_decl_english_ast
  | pointer_decl_english_ast      { $$ = (c_ast_pair_t){ $1, NULL }; }
  | reference_decl_english_ast    { $$ = (c_ast_pair_t){ $1, NULL }; }
  | type_english_ast              { $$ = (c_ast_pair_t){ $1, NULL }; }
  ;
...
var_decl_english_ast
  ...
  : sname_c Y_AS decl_english_ast
     ...
     */
  | sname_english_ast             { $$ = (c_ast_pair_t){ $1, NULL }; }
...
array_decl_c_ast
  : // in_attr: type_c_ast
    decl2_c_ast array_size_c_int gnu_attribute_specifier_list_c_opt
    {
...
pointer_decl_c_ast
  : pointer_type_c_ast { ia_type_ast_push( $1 ); } decl_c_ast
    {
      ia_type_ast_pop();
...
pointer_to_member_decl_c_ast
  : pointer_to_member_type_c_ast { ia_type_ast_push( $1 ); } decl_c_ast
    {
      ia_type_ast_pop();
...
reference_decl_c_ast
  : reference_type_c_ast { ia_type_ast_push( $1 ); } decl_c_ast
    {
      ia_type_ast_pop();
...
pointer_cast_c_ast
  : pointer_type_c_ast { ia_type_ast_push( $1 ); } cast_c_ast_opt
    {
      ia_type_ast_pop();
...
pointer_to_member_cast_c_ast
  : pointer_to_member_type_c_ast { ia_type_ast_push( $1 ); } cast_c_ast_opt
    {
      ia_type_ast_pop();
...
reference_cast_c_ast
  : reference_type_c_ast { ia_type_ast_push( $1 ); } cast_c_ast_opt
    {
      ia_type_ast_pop();
