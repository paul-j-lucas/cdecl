...
static char const *const PREDEFINED_STD_CPP[] = {
  ...
  "    class std::                   wstring",
  "    class std::                    stringbuf",
  "    class std::                   wstringbuf",
  "    class std::                    stringstream",
  "    class std::                   istringstream",
  "    class std::                   wstringstream",
  "    class std::                  wistringstream",
  "    class std::                   ostringstream",
  "    class std::                  wostringstream",
  "    class std::                    syncbuf",
  "    class std::                   wsyncbuf",
  "    class std::                   osyncstream",
  "    class std::                  wosyncstream",
  "    class std::                    time_base",
...
static char const *const PREDEFINED_STD_CPP_11[] = {
  ...
  "    struct std::                        atomic_char8_t",
  "    struct std::                        atomic_char16_t",
  "    struct std::                        atomic_char32_t",
  "    struct std::                        atomic_char",
  "    struct std::                        atomic_flag",
  "    struct std::                        atomic_int8_t",
  "    struct std::                        atomic_int16_t",
  "    struct std::                        atomic_int32_t",
  "    struct std::                        atomic_int64_t",
  "    struct std::                        atomic_int",
  "    struct std::                        atomic_int_fast8_t",
  "    struct std::                        atomic_int_fast16_t",
  "    struct std::                        atomic_int_fast32_t",
  "    struct std::                        atomic_int_fast64_t",
  "    struct std::                        atomic_int_least8_t",
  "    struct std::                        atomic_int_least16_t",
  "    struct std::                        atomic_int_least32_t",
  "    struct std::                        atomic_int_least64_t",
  "    struct std::                        atomic_intmax_t",
  "    struct std::                        atomic_intptr_t",
  "    struct std::                        atomic_llong",
  "    struct std::                        atomic_long",
  "    struct std::                        atomic_ptrdiff_t",
  "    struct std::                        atomic_schar",
  "    struct std::                        atomic_short",
  "    struct std::                        atomic_signed_lock_free",
  "    struct std::                        atomic_size_t",
  "    struct std::                        atomic_uchar",
  "    struct std::                        atomic_uint16_t",
  "    struct std::                        atomic_uint32_t",
  "    struct std::                        atomic_uint64_t",
  "    struct std::                        atomic_uint8_t",
  "    struct std::                        atomic_uint",
  "    struct std::                        atomic_uint_fast8_t",
  "    struct std::                        atomic_uint_fast16_t",
  "    struct std::                        atomic_uint_fast32_t",
  "    struct std::                        atomic_uint_fast64_t",
  "    struct std::                        atomic_uint_least8_t",
  "    struct std::                        atomic_uint_least16_t",
  "    struct std::                        atomic_uint_least32_t",
  "    struct std::                        atomic_uint_least64_t",
  "    struct std::                        atomic_uintmax_t",
  "    struct std::                        atomic_uintptr_t",
  "    struct std::                        atomic_ullong",
  "    struct std::                        atomic_ulong",
  "    struct std::                        atomic_unsigned_lock_free",
  "    struct std::                        atomic_ushort",
  "    struct std::                        atomic_wchar_t",
...
static char const *const PREDEFINED_STD_CPP_17[] = {
  ...
  "enum class std::filesystem::directory_options",
  "     class std::filesystem::file_status",
  "enum class std::filesystem::file_type",
  "     class std::filesystem::filesystem_error",
  "     class std::filesystem::path",
  "enum class std::filesystem::perms",
  "enum class std::filesystem::perm_options",
  "     class std::filesystem::recursive_directory_iterator",
  "    struct std::filesystem::space_info",
  "     class std::            string_view",
  "     class std::         u16string_view",
  "     class std::         u32string_view",
  "     class std::           wstring_view",
...
static char const *const PREDEFINED_STD_CPP_20[] = {
  "     class std::        ambiguous_local_time",
  "enum class std::chrono::choose",
  "     class std::chrono::day",
  "    struct std::        destroying_delete_t",
  "    struct std::chrono::file_clock",
  "     class std::        format_error",
  "    struct std::chrono::gps_clock",
  "    struct std::chrono::is_clock",
  "     class std::        jthread",
  "    struct std::chrono::last_spec",
  "     class std::chrono::leap_second",
  "    struct std::chrono::local_info",
  "    struct std::chrono::local_t",
  ...
  "    struct std::        nonstopstate_t",
  "    struct std::        partial_ordering",
  "     class std::      u8string_view",
  "     class std::        stop_source",
  "     class std::        stop_token",
  "    struct std::        strong_equality",
  "    struct std::        strong_ordering",
  "    struct std::chrono::sys_info",
  "    struct std::chrono::tai_clock",
  "    struct std::chrono::time_zone",
  "     class std::chrono::time_zone_link",
  "    struct std::chrono::tzdb",
  "    struct std::chrono::tzdb_list",
  "    struct std::chrono::utc_clock",
  "     class std::chrono::weekday",
  "     class std::chrono::weekday_indexed",
  "     class std::chrono::weekday_last",
  "    struct std::        weak_equality",
  "    struct std::        weak_ordering",
