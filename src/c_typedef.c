...
static char const *const PREDEFINED_STD_CPP[] = {
  ...
  "namespace std { class ios_base { enum                event;         }; }",
  "namespace std { class ios_base { typedef void      (*event_callback)(std::ios_base::event, std::ios_base&, int); }; }",
  ...
  "namespace std { class ios_base { typedef unsigned    fmtflags;      }; }",
  "namespace std { class ios_base { class               Init;          }; }",
  "namespace std { class ios_base { typedef unsigned    iostate;       }; }",
  "namespace std { class                                length_error;     }",
  "namespace std { class                                locale;           }",
  "namespace std { class                                logic_error;      }",
  "namespace std { class ctype_base { typedef unsigned  mask;          }; }",
  "namespace std { class                                messages_base;    }",
  "namespace std { class                                money_base;       }",
  "namespace std { struct                               nothrow_t;        }",
  "namespace std { class ios_base { typedef unsigned    openmode;      }; }",
  ...
  "namespace std { class ios_base { typedef int         seekdir;       }; }",
