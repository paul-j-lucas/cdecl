...
static cdecl_keyword_t const CDECL_KEYWORDS[] = {
  ...
  { L_bit,            TOKEN( Y_bit,               AC_LANG(NONE)             ) },
  { H_bit_precise,    TOKEN( Y_bit_precise,       AC_LANG(_BitInt)          ) },
  { L_bits,           TOKEN( Y_bits,              AC_LANG(ANY)              ) },
  { L_bool,           C_SYN( true,                AC_LANG(NONE),
                        { LANG__Bool, L__Bool },
                        { LANG_ANY,   L_bool  }                             ) },
  { L_boolean,        C_SYN( true,                AC_LANG(NONE),
                        { LANG__Bool, L__Bool },
                        { LANG_ANY,   L_bool  }                             ) },
  { L_Boolean,        C_SYN( true,                AC_LANG(BOOL_TYPE),
                        { LANG__Bool, L__Bool },
                        { LANG_ANY,   L_bool  }                             ) },
  ...
  { L_precise,        TOKEN( Y_precise,           AC_LANG(_BitInt)          ) },
