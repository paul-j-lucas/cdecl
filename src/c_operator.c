...
static c_operator_t const C_OPERATOR[] = {
  ...
  { C_OP_DELETE_ARRAY,        "delete[]", LANG_CPP_ANY,     EIT, 1, UNL },
  { C_OP_EXCLAM,              "!",        LANG_CPP_ANY,     EIT, 0, 1   },
  { C_OP_EXCLAM_EQUAL,        "!=",       LANG_CPP_ANY,     EIT, 1, 2   },
  { C_OP_PERCENT,             "%",        LANG_CPP_ANY,     EIT, 1, 2   },
  { C_OP_PERCENT_EQUAL,       "%=",       LANG_CPP_ANY,     EIT, 1, 2   },
  { C_OP_AMPER,               "&",        LANG_CPP_ANY,     EIT, 0, 2   },
  { C_OP_AMPER2,              "&&",       LANG_CPP_ANY,     EIT, 1, 2   },
  { C_OP_AMPER_EQUAL,         "&=",       LANG_CPP_ANY,     EIT, 1, 2   },
  { C_OP_PARENS,              "()",       LANG_CPP_ANY,     MBR, 0, UNL },
  { C_OP_STAR,                "*",        LANG_CPP_ANY,     EIT, 0, 2   },
  { C_OP_STAR_EQUAL,          "*=",       LANG_CPP_ANY,     EIT, 1, 2   },
  { C_OP_PLUS,                "+",        LANG_CPP_ANY,     EIT, 0, 2   },
  { C_OP_PLUS2,               "++",       LANG_CPP_ANY,     EIT, 0, 2   },
  { C_OP_PLUS_EQUAL,          "+=",       LANG_CPP_ANY,     EIT, 1, 2   },
  { C_OP_COMMA,               ",",        LANG_CPP_ANY,     EIT, 1, 2   },
  { C_OP_MINUS,               "-",        LANG_CPP_ANY,     EIT, 0, 2   },
  { C_OP_MINUS2,              "--",       LANG_CPP_ANY,     EIT, 0, 2   },
  { C_OP_MINUS_EQUAL,         "-=",       LANG_CPP_ANY,     EIT, 1, 2   },
  { C_OP_ARROW,               "->",       LANG_CPP_ANY,     MBR, 0, 0   },
  { C_OP_ARROW_STAR,          "->*",      LANG_CPP_ANY,     EIT, 1, 2   },
  { C_OP_DOT,                 ".",        LANG_CPP_ANY,     XXX, 0, 0   },
  { C_OP_DOT_STAR,            ".*",       LANG_CPP_ANY,     XXX, 0, 0   },
  { C_OP_SLASH,               "/",        LANG_CPP_ANY,     EIT, 1, 2   },
  { C_OP_SLASH_EQUAL,         "/=",       LANG_CPP_ANY,     EIT, 1, 2   },
  { C_OP_COLON2,              "::",       LANG_CPP_ANY,     XXX, 0, 0   },
  { C_OP_LESS,                "<",        LANG_CPP_ANY,     EIT, 1, 2   },
  ...
  { C_OP_GREATER_EQUAL,       ">=",       LANG_CPP_ANY,     EIT, 1, 2   },
  { C_OP_GREATER2,            ">>",       LANG_CPP_ANY,     EIT, 1, 2   },
  { C_OP_GREATER2_EQUAL,      ">>=",      LANG_CPP_ANY,     EIT, 1, 2   },
  { C_OP_QMARK_COLON,         "?:",       LANG_CPP_ANY,     XXX, 0, 0   },
  { C_OP_BRACKETS,            "[]",       LANG_CPP_MAX(20), MBR, 1, 1   },
  { C_OP_BRACKETS,            "[]",       LANG_CPP_MIN(23), MBR, 0, UNL },
  { C_OP_CARET,               "^",        LANG_CPP_ANY,     EIT, 1, 2   },
  { C_OP_CARET_EQUAL,         "^=",       LANG_CPP_ANY,     EIT, 1, 2   },
  { C_OP_PIPE,                "|",        LANG_CPP_ANY,     EIT, 1, 2   },
  { C_OP_PIPE_EQUAL,          "|=",       LANG_CPP_ANY,     EIT, 1, 2   },
  { C_OP_PIPE2,               "||",       LANG_CPP_ANY,     EIT, 1, 2   },
  { C_OP_TILDE,               "~",        LANG_CPP_ANY,     EIT, 0, 1   },
};
