...
3. **Amount and substantiality of the portion used
   ...
   | :--------- | ----: | :--------- | ----: | ----: |
   | `cdgram.y` |  855  | `parser.y` |  8046 | 10.6% |
   | `cdlex.l`  |   75  | `lexer.l`  |  1283 |  5.8% |
   | `cdecl.c`  | 1014  | `*.[ch]`   | 27215 |  3.7% |
   | **Total**  | 1944  |            | 36544 |  5.3% |

   Hansen's version of **cdecl** accounts for only 5.3%
   of a recent total
